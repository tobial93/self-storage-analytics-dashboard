-- Marketing Analytics Dashboard - Initial Schema (Fixed for Supabase Permissions)
...
COMMENT ON FUNCTION public.get_user_org_id() IS 'Helper function to get current users organization ID from Clerk JWT';
