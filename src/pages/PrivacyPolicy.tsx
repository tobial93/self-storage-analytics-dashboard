        ...
        <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>Provide, maintain, and improve AdInsights services</li>
          ...
          <section>
            ...
            <p>You can access, export, or delete your data at any time. To disconnect ad platforms, visit the Integrations page. To delete your account and all associated data, contact support at <a href="mailto:support@adinsights.io" className="text-primary hover:underline">support@adinsights.io</a>.</p>
          </section>
          ...
          <section>
            ...
            <p>For questions about this privacy policy, contact us at <a href="mailto:support@adinsights.io" className="text-primary hover:underline">support@adinsights.io</a>.</p>
          </section>
        </div>
      </main>
    </div>
